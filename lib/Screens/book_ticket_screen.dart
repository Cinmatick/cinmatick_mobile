          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  textInfo(
                      widget.date, FontWeight.w500, Colors.white, 12, "Roboto"),
                  textInfo(
                      "Reviews", FontWeight.w500, Colors.white, 12, "Roboto"),
                  textInfo("⭐ ${widget.rating}.0", FontWeight.w500,
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    width: 60,
                    child: Center(
                      child: textInfo("Action", FontWeight.w500, Colors.black,
                          10, "Roboto"),
                    ),
                  ),
                  Container(
                    ...
                    width: 80,
                    child: Center(
                      child: textInfo("Adventure", FontWeight.w500,
                          Colors.black, 10, "Roboto"),
                    ),
                  ),
                  Container(
                    color: const Color.fromRGBO(255, 134, 50, 10),
                    ...
                    width: 60,
                    child: Center(
                      child: textInfo("Fantasy", FontWeight.w500, Colors.black,
                          10, "Roboto"),
                    ),
                  ),
                ],
              ...
              Column(
                children: [
                  textInfo(
                      "Casts:", FontWeight.w500, Colors.white, 13, "Roboto"),
                  textInfo(
                      widget.pg, FontWeight.w400, Colors.white, 12, "Roboto"),
                  const SizedBox(height: 20),
                  textInfo("Description", FontWeight.w400, Colors.white, 18,
                      "Roboto"),
                  textInfo(widget.description, FontWeight.w400, Colors.white,
                      14, "Roboto"),
                ],
              ),
